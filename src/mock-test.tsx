...
export default function MockTest({ user }: { user: any }) {
  ...
  const handleSectionEnd = useCallback(() => {
    ...
    // Flush any in-progress TITA draft before grading
    const qs = selectedTest ? sectionQuestions(selectedTest, SECTION_ORDER[sectionIdx]) : [];
  ...
  }, [submitted, sectionIdx, selectedTest, currentIdx, titaDraft, sectionQuestions]);
